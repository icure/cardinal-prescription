...
function encodeBase32(data, alphabet) {
  ...
  while ((position._v + 5 | 0) < data.length) {
    ...
    while (inductionVariable < last) {
      ...
      var tmp1 = index;
      index = tmp1 + 1 | 0;
      accumulator = accumulator.g3(element.f3(new Long(255, 0)).c3(32 - imul(8, tmp1) | 0));
    }
    ...
    if (0 <= inductionVariable_0)
      do {
        ...
        var char = chunk.d3(imul(5, index_0)).j1() & 31;
  ...
  var inductionVariable_1 = this_0.f1_1;
  var last_0 = this_0.g1_1;
  if (inductionVariable_1 <= last_0)
    do {
      ...
      var octet = tmp_2;
      accumulator_0 = acc.g3(octet.f3(new Long(255, 0)).c3(32 - imul(8, idx) | 0));
    }
  ...
  if (padSize <= inductionVariable_2)
    do {
      ...
      var char_0 = chunk_0.d3(imul(5, index_1)).j1() & 31;
...
function decodeBase32(input, lookupTable) {
  ...
  while (!packet.h19()) {
    ...
    while (inductionVariable_0 < last_1) {
      ...
      var found = tmp_3;
      accumulator = result.g3(found.c3(imul(7 - tmp1 | 0, 5)));
    }
    var chunk = accumulator;
    var tmp_4;
    switch (read) {
    ...
    if (bytesToLoad <= inductionVariable_1)
      do {
        ...
        inductionVariable_1 = inductionVariable_1 + -1 | 0;
        var origin = chunk.d3(imul(8, index_1)).f3(new Long(255, 0));
        this_1.z1a(origin.i3());
      }
...
function toHexString_0(_this__u8e3s4) {
  return toHexString(_this__u8e3s4, Companion_getInstance().fg_1);
}
function hexToByteArray_0(hexString) {
  return hexToByteArray(hexString, Companion_getInstance().fg_1);
}
