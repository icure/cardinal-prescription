...
protoOf(atomicfu$AtomicRefArray$ref).lk = function () {
  return this.kk_1.length;
};
protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
  return this.kk_1[index];
};
...
protoOf(AtomicRef).mk = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicRef).nk = function () {
...
protoOf(AtomicBoolean).ok = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicBoolean).nk = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicLong).nk = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicLong).atomicfu$getAndAdd$long = function (delta) {
  var oldValue = this.kotlinx$atomicfu$value;
  this.kotlinx$atomicfu$value = this.kotlinx$atomicfu$value.t2(delta);
  return oldValue;
};
...
protoOf(AtomicInt).qk = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicInt).nk = function () {
  return this.kotlinx$atomicfu$value;
};
...
defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).lk);
//endregion
