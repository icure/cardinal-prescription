...
function Events() {
  this.t2m_1 = new CopyOnWriteHashMap();
}
protoOf(Events).u2m = function (definition, value) {
  var exception = null;
  var tmp0_safe_receiver = this.t2m_1.g27(definition);
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'io.ktor.util.internal.LockFreeLinkedListHead.forEach' call
    var tmp = tmp0_safe_receiver.fy();
